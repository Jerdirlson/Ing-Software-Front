            ...
            <div className='flex flex-col'>
                <main className="flex flex-col pt-32 text-2xl font-light justify-center items-center">
                    ...
                    <section className="flex mx-48 mb-10">
                        ...
                        <div className='flex flex-col justify-center'>
                            <a className="m-2 hover:scale-110 duration-100 w-12 h-12 rounded-lg p-2 hover:bg-primary-blue hover:fill-white" href="https://cdn.discordapp.com/attachments/1082099606839644273/1220555869809410149/IMG-20240321-WA0096.jpg?ex=662f023c&is=662db0bc&hm=6ce28538971f0bd3009e3607dbe16087dba4651dadabe4246470b5a837521978&">
                            ...
                            <a className="m-2 hover:scale-110 duration-100 w-12 h-12 rounded-lg p-2 hover:bg-primary-blue hover:fill-white" href="https://media.discordapp.net/attachments/860225409369899011/925050870230548540/Aether_was_here.gif.gif?ex=662f1702&is=662dc582&hm=98a52e289f0339048aa9e55a97c89a9140b4702f01753ec7f8ea9de73576873d&">
                ...
                <section className="flex flex-col items-center w-full mb-20">
                    <div className='flex p-10'>
                        <button className={`flex flex-col items-center justify-center overflow-hidden rounded-full w-52 h-52 mx-20 hover:bg-gray-100${activeButton === "mision" ? "scale-110 shadow-customButton duration-300" : ""}`} onClick={() => handleInfo("mision")}>
                            <img className="w-1/2 h-1/2 ml-6" src={MISION_IMG} alt="" />
                            <h3 className='text-2xl text-black font-bold'>Misión</h3>
                        </button>
                        <button className={`flex flex-col items-center justify-center overflow-hidden rounded-full w-52 h-52 mx-20 hover:bg-gray-100${activeButton === "vision" ? "scale-110 shadow-customButton duration-300" : ""}`} onClick={() => handleInfo("vision")}>
                            <img className="w-1/2 h-1/2 " src={VISION_IMG} alt="" />
                            <h3 className='text-2xl text-black font-bold'>Visión</h3>
                        </button>
                        <button className={`flex flex-col items-center justify-center overflow-hidden rounded-full w-52 h-52 mx-20 hover:bg-gray-100${activeButton === "objetivo" ? "scale-110 shadow-customButton duration-300" : ""}`} onClick={() => handleInfo("objetivo")}>
