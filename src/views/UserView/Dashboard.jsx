        ...
        <>
            ...
            <section className='bg-white mt-44 px-28 py-12 pb-0 sm:pb-12 sm:m-0 lg:px-24 2xl:px-48'>
                ...
                <div className='hidden sm:block lg:mt-12'>
                    ...
                    expertos está aquí para cuidar de ti. Con tecnología de vanguardia y un enfoque centrado en el 
                    paciente, estamos comprometidos en proporcionarte la mejor atención posible para tu salud y bienestar.
                    </p>
            ...
            <section className='bg-secondary-blue text-white'>
                <div className='flex flex-row items-center justify-center py-12 sm:justify-evenly sm:flex-col lg:flex-row sm:px-2 md:px-4 lg:px-6 xl:px-8 '>
                    ...
                    <div className=' flex flex-col text-pretty w-1/2 mr-2 sm:w-auto sm:m-0 sm:px-8 max-w-2xl md:px-2 2xl:px-0'>
                        ...
                        <p className='mb-6 hidden 2xl:text-base sm:text-sm sm:block'> 
                        SaludPro está presente en múltiples ubicaciones para brindarte atención médica accesible y 
                        conveniente. Nuestras sedes están estratégicamente ubicadas en toda la región para garantizar 
                        que nuestros servicios estén al alcance de todos. Cada una de nuestras sedes cuenta con 
                        instalaciones modernas, equipamiento de última generación y un equipo médico altamente calificado, 
                        listo para atenderte con el más alto nivel de cuidado
                        </p>
                        <p className='mb-6 text-sm 2xl:text-base'>
                            Con sedes en: Lebrija, Rionegro, Bucaramanga y toda su area metropolitana.
                        </p>
                        <p className='mb-6 text-sm 2xl:text-base'>
                        Encuentra la sede más cercana a ti y experimenta la excelencia en atención médica que caracteriza a SaludPro.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className='flex items-center sm:justify-evenly pt-12 sm:px-48  xl:px-36'>
                ...
                <div className='flex flex-col px-1 lg:items-center lg:px-4 lg:flex-row sm:justify-evenly '>
                    ...
                    <div className='text-black p-2 text-pretty max-w-md hidden lg:block'>
                        <p className='text-sm mt-10 2xl:text-base'>
                            Nuestra misión es simple pero poderosa: mejorar la vida de nuestros pacientes a 
                            través de un cuidado compasivo, innovador y personalizado. Con un equipo multidisciplinario 
                            de profesionales de la salud altamente calificados, estamos aquí para acompañarlo en cada paso 
                            de su viaje hacia una vida más saludable y feliz.
                        </p>
                    </div>
            ...
            <section className='text-black flex items-center justify-center flex-col px-8 py-4 md:px-24 md:py-12 lg:px-48 lg:py-24 lg:pt-8 lg:pb-20'>
                ...
                En SaludPro, entendemos la importancia de la accesibilidad en la atención médica. Por eso, nuestras sedes están abiertas para ti en horarios flexibles. Estamos aquí para atenderte y cuidar de tu salud cuando más nos necesitas.
                </div>
                <div className='flex justify-between items-center'>
                    ...
                    <div className='p-4 flex justify-center flex-col text-pretty'>
                        ...
                        <p className='mb-6 text-xs xl:text-sm 2xl:text-base'>
                            Nos esforzamos por estar disponibles cuando más nos necesitas. Nuestras sedes están abiertas 
                            para ti de lunes a viernes, con horarios extendidos para ofrecerte la atención médica que mereces. Te esperamos en los horarios:
                        </p>
                        <p className='text-xs xl:text-sm 2xl:text-base'>
                            Lunes a Viernes: <br/>
                            7:00 a.m - 7:00 p.m.
                        </p>
                        <p className='mb-6 text-xs hidden md:block xl:text-sm 2xl:text-base'>
                            Sábados <br/>
                            7:00 a.m - 4:00 p.m.
                        </p>
                        <p className='text-xs hidden md:block xl:text-sm 2xl:text-base'>
                        Queremos facilitarte el acceso a la atención médica de calidad. Por ello, nuestras sedes están disponibles para 
                        ti de lunes a viernes, desde tempranas horas de la mañana hasta la tarde. Visítanos y descubre la comodidad de recibir cuidados médicos en un 
                        horario que se adapta a tu vida
                        </p>
                    </div>
