...
import StepRe1 from '../../components/ReScheduleUSER/StepRe1.jsx';
import StepRe2 from '../../components/ReScheduleUSER/StepRe2.jsx';
import StepRe3 from '../../components/ReScheduleUSER/StepRe3.jsx';
import ConfirmRe from '../../components/ReScheduleUSER/ConfirmRe.jsx';

const UserReScheduleAppoinment = () => {
                        ...
                        <div>
                            ...
                            {currentStep === 3 ? '' :
                                <section className='flex flex-col items-center'>
                                    <h1 className='font-bold text-4xl'>Re-Agendamiento de cita</h1>
                                    <h3 className='font-light text-2xl mt-2 text-primaryGray'>Paso {currentStep} de 2</h3>
...
const UserReScheduleAppoinmentPro = () => (
    <StepsProvider>
        <UserReScheduleAppoinment />
    </StepsProvider>
)
export default UserReScheduleAppoinmentPro 