...
const ServiceCard = ({ title, summary, img }) => {
    return (
        <article className="relative flex w-48 h-auto flex-col 2xl:w-72 xl:w-60 lg:w-52">
            ...
            <div className='relative overflow-hidden h-auto mx-2 px-4 py-10 -translate-y-10 flex flex-col items-center justify-center rounded-xl bg-white bg-clip-border text-gray-700 shadow-md text-sm 2xl:text-xl xl:text-lg lg:text-base cursor-pointer'>
